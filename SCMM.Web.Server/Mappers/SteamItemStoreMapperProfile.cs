    ...
    public class SteamItemStoreMapperProfile : Profile
    {
        public SteamItemStoreMapperProfile()
        {
            ...
            CreateMap<SteamStoreItemItemStore, StoreItemDetailsDTO>()
                ...
                .ForMember(x => x.CreatorName, o => o.MapFrom(p => p.Item.Description.CreatorProfile != null ? p.Item.Description.CreatorProfile.Name : p.Item.App.PublisherName))
            ...
            CreateMap<SteamStoreItem, StoreItemDetailsDTO>()
                .ForMember(x => x.Guid, o => o.MapFrom(p => p.Id))
                .ForMember(x => x.Id, o => o.MapFrom(p => p.SteamId))
                .ForMember(x => x.AppId, o => o.MapFrom(p => p.App.SteamId))
                .ForMember(x => x.AssetDescriptionId, o => o.MapFrom(p => p.Description.ClassId))
                .ForMember(x => x.ItemDefinitionId, o => o.MapFrom(p => p.Description.ItemDefinitionId))
                .ForMember(x => x.WorkshopFileId, o => o.MapFrom(p => p.Description.WorkshopFileId))
                .ForMember(x => x.WorkshopFileUrl, o => o.MapFrom(p => p.Description.WorkshopFileUrl))
                .ForMember(x => x.MarketListingId, o => o.MapFrom(p => p.Description.MarketItem != null ? p.Description.MarketItem.SteamId : null))
                .ForMember(x => x.CreatorId, o => o.MapFrom(p => p.Description.CreatorProfile != null ? p.Description.CreatorProfile.SteamId : p.App.SteamId))
                .ForMember(x => x.CreatorName, o => o.MapFrom(p => p.Description.CreatorProfile != null ? p.Description.CreatorProfile.Name : p.App.PublisherName))
                .ForMember(x => x.CreatorAvatarUrl, o => o.MapFrom(p => p.Description.CreatorProfile != null ? p.Description.CreatorProfile.AvatarUrl : p.App.IconUrl))
                .ForMember(x => x.ItemType, o => o.MapFrom(p => p.Description.ItemType))
                .ForMember(x => x.ItemCollection, o => o.MapFrom(p => p.Description.ItemCollection))
                .ForMember(x => x.Name, o => o.MapFrom(p => p.Description.Name))
                .ForMember(x => x.Description, o => o.MapFrom(p => p.Description.Description))
                .ForMember(x => x.IsPermanent, o => o.MapFrom(p => p.Description.IsPermanent))
                .ForMember(x => x.HasGlow, o => o.MapFrom(p => p.Description.HasGlow))
                .ForMember(x => x.HasGlowSights, o => o.MapFrom(p => p.Description.HasGlowSights))
                .ForMember(x => x.GlowRatio, o => o.MapFrom(p => Math.Round((p.Description.GlowRatio ?? 0) * 100, 0)))
                .ForMember(x => x.HasCutout, o => o.MapFrom(p => p.Description.HasCutout))
                .ForMember(x => x.CutoutRatio, o => o.MapFrom(p => Math.Round((p.Description.CutoutRatio ?? 0) * 100, 0)))
                ...
                .ForMember(x => x.StorePrice, o => o.MapFromUsingCurrencyTable(p => p.Prices))
                .ForMember(x => x.StorePriceUsd, o => o.MapFrom(p => p.Price))
                .ForMember(x => x.TopSellerIndex, o => o.MapFrom(p => (int?)null))
                .ForMember(x => x.IsStillAvailableFromStore, o => o.MapFrom(p => p.IsAvailable))
                .ForMember(x => x.HasReturnedToStoreBefore, o => o.MapFrom(p => p.HasReturnedToStore))
                .ForMember(x => x.MarketPrice, o => o.MapFromUsingCurrencyExchange(p => p.Description.MarketItem != null ? p.Description.MarketItem.SellOrderLowestPrice : null, p => p.Description.MarketItem != null ? p.Description.MarketItem.Currency : null))
                .ForMember(x => x.MarketSupply, o => o.MapFrom(p => p.Description.MarketItem != null ? (long?)p.Description.MarketItem.SellOrderCount : null))
                .ForMember(x => x.MarketDemand24hrs, o => o.MapFrom(p => p.Description.MarketItem != null ? (long?)p.Description.MarketItem.Last24hrSales : null))
                ...
                .ForMember(x => x.SubscriptionsTimeline, o => o.MapFrom(p => p.SubscriberTimeline.ToDictionary(x => x.Timestamp.Ticks, x => x.Subscribers)))
                .ForMember(x => x.IsCommodity, o => o.MapFrom(p => p.Description.IsCommodity))
                .ForMember(x => x.IsMarketable, o => o.MapFrom(p => p.Description.IsMarketable))
                .ForMember(x => x.MarketableRestrictionDays, o => o.MapFrom(p => p.Description.MarketableRestrictionDays))
                .ForMember(x => x.IsTradable, o => o.MapFrom(p => p.Description.IsTradable))
                .ForMember(x => x.TradableRestrictionDays, o => o.MapFrom(p => p.Description.TradableRestrictionDays))
                .ForMember(x => x.IsPublisherDrop, o => o.MapFrom(p => p.Description.IsPublisherDrop))
                .ForMember(x => x.IsLootCrateDrop, o => o.MapFrom(p => p.Description.IsLootCrateDrop))
                .ForMember(x => x.IsBreakable, o => o.MapFrom(p => p.Description.IsBreakable))
                .ForMember(x => x.BreaksIntoComponents, o => o.MapFrom(p => p.Description.BreaksIntoComponents.ToDictionary(x => x.Key, x => x.Value)))
                .ForMember(x => x.IsBanned, o => o.MapFrom(p => p.Description.IsBanned))
                .ForMember(x => x.BanReason, o => o.MapFrom(p => p.Description.BanReason))
                .ForMember(x => x.Notes, o => o.MapFrom(p => p.Description.Notes))
                .ForMember(x => x.IsDraft, o => o.MapFrom(p => false));
